...
const ValueProposition: React.FC = () => {
  return (
    <section className="py-20 bg-[#f9fafb]">
      <div className="container mx-auto px-4 mb-12">
        <div className="flex flex-col lg:flex-row gap-12">
          ...
          <div className="lg:w-1/2 text-gray-600 leading-relaxed space-y-4">
            ...
            <p>
              At Caring Skin, we take the guesswork out of your skincare. Our team of dedicated estheticians deliver meticulous therapeutic treatments tailored to your unique skin profile, generated through cutting-edge analysis machines.
            </p>
            <p>
      ...
      {/* Video Placeholder */}
      <div className="relative w-full h-[500px] bg-cover bg-center" style={{ backgroundImage: 'url(https://caringskin.com.sg/wp-content/uploads/2026/01/Untitled.001.jpeg)' }}>
        <div className="absolute inset-0 bg-black/40 flex items-center justify-center">
          <a
            href="https://youtu.be/NOSDbehFXig"
            target="_blank"
            rel="noreferrer"
